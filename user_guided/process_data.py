...
from user_guided.config import *
...
class AssemblyGraph:
    ...
    def get_graph_node_data(self, body_uuid, occ_uuid=None, occ=None, transform=None):
        ...
        node_data["material_category_tier2"] = body["material_category"]["tier2"]
        node_data["material_category_tier3"] = body["material_category"]["tier3"]
